        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                @if (Route::has('register'))
                    <a class="px-2 py-2 ml-2 text-xs font-semibold tracking-widest text-black uppercase transition duration-150 ease-in-out bg-white border border-black rounded-md hover:bg-gray-200 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25" href="{{ route('register') }}">
                        {{ __('register') }}
                    </a>
                @endif
